...
void FSM_ModeControl(void){
    switch(mode){
        case INIT:
            ...
            LcdPrintStringS(1, 0, "    _ MANUAL _  ");
            ...
            break;
        case MANUAL:
            if(BTN_IsHeld(3)) MTR_Set(1);
            else MTR_Set(0);

            if(BTN_IsPressed(1)){
                LcdPrintStringS(0, 0, "AUTO :         s");
                LcdPrintStringS(1, 0, "CUP  :          ");
        ...
        case AUTO:
            ...
            else if(BTN_IsPressed_s(1)){
                LcdPrintStringS(0, 0, "               s");
            ...
            else if(BTN_IsPressed_s(2) && BTN_IsPressed_s(0)){
                LcdPrintStringS(0, 0, " Delete All ?   ");
                LcdPrintStringS(1, 0, "[N]   [OK]   [N]");
        ...
        case ADJUST_TIME:
            ...
            break;
        case INCREASE:
            if(BTN_IsPressed_ms(0, 500) && _counterDelay <= 0){

                _counterDelay = 6;
                _timeAuto = _timeAuto + 100 > 9900 ? 9900 : _timeAuto + 100;
                LcdPrintFloatS(0, 8, _timeAuto);
                flagPressAdjust = 1;
            }
            else if(!BTN_IsHeld(0)) {
                if(flagPressAdjust == 0){
                _timeAuto = _timeAuto + 10 > 9900 ? 9900 : _timeAuto + 10;
                }
                LcdPrintFloatS(0, 8, _timeAuto);
                mode = ADJUST_TIME;
            }
            break;
        case DECREASE:
            if(BTN_IsPressed_ms(2, 500) && _counterDelay <= 0){
        ...
        case START_AUTO:
            ...
            if(_countAuto < 5 || BTN_IsPressed(1)){
                LcdPrintStringS(0, 0, "AUTO :         s");
                LcdPrintStringS(1, 0, "CUP  :          ");
            ...
            break;
        case DELETE_ALL:
            if(BTN_IsPressed(2) || BTN_IsPressed(0)){
                mode = INIT;
            }
            else if(BTN_IsPressed(1)){
