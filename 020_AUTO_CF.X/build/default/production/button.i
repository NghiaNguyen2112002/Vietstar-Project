...
unsigned char buttonInputMask[4] = {0x01, 0x02, 0x04, 0x08};

static unsigned char buttonBuffer[4] = {1, 1, 1, 1};

static unsigned char debounceButtonBuffer1[4];
static unsigned char debounceButtonBuffer2[4];

static unsigned char flagForButtonPress[4];
static unsigned char flagForButtonPress_s[4];
static unsigned int counterForButtonPress[4];
...
void BTN_Reading(void){
    ...
    for(i = 0; i < 4; i++){
        ...
        debounceButtonBuffer1[i] = PORTA & buttonInputMask[i];

        if(debounceButtonBuffer1[i] == debounceButtonBuffer2[i]){
            buttonBuffer[i] = debounceButtonBuffer1[i];
            if(buttonBuffer[i] == 0){
                if(counterForButtonPress[i] < 200){
